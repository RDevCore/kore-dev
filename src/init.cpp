...
std::string LicenseInfo()
{
    return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf(_("Copyright (C) 2015-%i The Kore Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
...
#ifdef ZEROCOIN
    //KORE: Load Accumulator Checkpoints according to network (main/test/regtest)
...
// ********************************************************* Step 8: load wallet
    ...
    if (fDisableWallet) {
        ...
        //zwalletMain = new CzKOREWallet(pwalletMain->strWalletFile);
